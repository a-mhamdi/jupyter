...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$c5SsM4aUv+U/P+dzMg/Wjg$DrPhiihKRyDZ6p68JUdLMP615XCIyVsIVQgUKMocT0s'
...
#  Choices: any of ['sha512', 'sha3_224', 'sha3_256', 'sha384', 'sha224', 'sha1', 'sha3_512', 'blake2b', 'sha3_384', 'md5', 'sha256', 'blake2s']
#  Default: 'sha256'
